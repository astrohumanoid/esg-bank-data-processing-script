...
df['Sentences'] = df_reset.apply(lambda x : create_txt_file(x['index_name'], x['Year of the report'], x["Quarter of the report"], x["Central Index Key"], x['Report as Text'], 4380), axis = 1)